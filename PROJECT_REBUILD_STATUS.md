...
| R. Slice B 爆款/共题/选题 | 进行中 | Task 8–9 已完成：`creator-hotness-v1` 支持速度/加速度、严格 peer cohort、博主自身基线和可解释惩罚；规则优先垂类分类已处理“游戏皮肤/护肤”“明星穿搭/娱乐八卦”“AI 产品/泛科技”等歧义。Creator Topic 区分单博主爆款、独立多博主共题、同博主跨平台同步与转载网络；跨平台扩散要求 24 小时内至少 3 位独立博主和 2 个平台。每个采用计数均保存原帖证据 URL、首发者、跟进序列和版本化快照。新增 Task 9 定向 `12/12`，Creator+旧 Topic 联动 `98/98`。Task 10 待开始。 |
