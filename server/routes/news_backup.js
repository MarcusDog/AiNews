...
router.get('/status', async (req, res) => {
  try {
    const newsCount = NewsService.getNewsCount();
    ...
    try {
      ...
      console.warn('获取分类失败:', catError.message);
      categories = [];
    }
